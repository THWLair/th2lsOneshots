...
function goodNoteHit(id, direction, noteType, isSustainNote)
    if enableCustomRatings and not isSustainNote then
        sick = (getPropertyFromGroup('notes', id, 'rating') == 'sick')
        good = (getPropertyFromGroup('notes', id, 'rating') == 'good')
        bad = (getPropertyFromGroup('notes', id, 'rating') == 'bad')
        shit = (getPropertyFromGroup('notes', id, 'rating') == 'shit')
        combo = combo + 1
        if sick then
